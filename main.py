...
@app.route("/edit_post/<post_id>", methods=["GET", "POST"])  # htmls forms don't accept PUT, PATCH and DELETE method
...
def add_post():
    ...
    if form.validate_on_submit():
        ...
        new_post = BlogPost(title=form.title.data, subtitle=form.subtitle.data, body=form.body.data,
                            date=today.strftime("%B %d, %Y"), img_url=form.img_url.data, author=form.author.data)
